...
export const cardObjProjects = {
    ...
    cards: [
        ...
        {
            id: 'PR4', cTitle: 'Note Taking App', cDesc: 'React App to take and retain notes', cImg: MYNotes, alt: 'MyNotesApp', btn: "Note Sth Down Now", url: 'https://mynotesnowapp.netlify.app/',
        },
        {
